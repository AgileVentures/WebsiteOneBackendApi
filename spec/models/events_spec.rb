...
RSpec.describe Event do
  ...
  context 'can remove event instance' do
    ...
    it 'should remove an event instance when requested and date found' do
      Delorean.time_travel_to(Time.zone.parse('2013-06-16 09:27:00 UTC'))
      @event.remove_from_schedule(Time.zone.parse('2013-6-23 09:00:00 UTC'))
      expect(@event.schedule.first(4)).to eq(['Sat, 22 Jun 2013 09:00:00 UTC +00:00',
        'Sat, 29 Jun 2013 09:00:00 UTC +00:00', 'Sun, 30 Jun 2013 09:00:00 UTC +00:00',
    ...
    it 'should move the start date forward when the event instance to be removed is the first in the series' do
      Delorean.time_travel_to(Time.zone.parse('2013-06-16 09:27:00 UTC'))
      @event.remove_from_schedule(Time.zone.parse('2013-6-22 09:00:00 UTC'))
  ...
  context 'should create a scrum event that ' do
    ...
    it 'is scheduled for every weekend' do
      ...
      expect(event.schedule.first(5)).to eq(['Sat, 22 Jun 2013 09:00:00 UTC +00:00',
        'Sun, 23 Jun 2013 09:00:00 UTC +00:00', 'Sat, 29 Jun 2013 09:00:00 UTC +00:00',
        'Sun, 30 Jun 2013 09:00:00 UTC +00:00', 'Sat, 06 Jul 2013 09:00:00 UTC +00:00'])
    end
    ...
    it 'is scheduled for every Sunday' do
      ...
      expect(event.schedule.first(5)).to eq(['Sun, 23 Jun 2013 09:00:00 UTC +00:00',
        'Sun, 30 Jun 2013 09:00:00 UTC +00:00', 'Sun, 07 Jul 2013 09:00:00 UTC +00:00',
        'Sun, 14 Jul 2013 09:00:00 UTC +00:00', 'Sun, 21 Jul 2013 09:00:00 UTC +00:00'])
    end
    ...
    it 'is scheduled for every Monday' do
      ...
      expect(event.schedule.first(5)).to eq(['Mon, 17 Jun 2013 09:00:00 GMT +00:00',
        'Mon, 24 Jun 2013 09:00:00 GMT +00:00', 'Mon, 01 Jul 2013 09:00:00 GMT +00:00',
        'Mon, 08 Jul 2013 09:00:00 GMT +00:00', 'Mon, 15 Jul 2013 09:00:00 GMT +00:00'])
    end
  end
  ...
  # end
    ...
    describe '#next_event_occurrence_with_time' do
      before(:each) do
        ...
        @event2 = FactoryBot.build(:event,
                                    name: 'Spec Scrum2',
                                    start_datetime: 'Mon, 11 Jun 2013 09:00:00 UTC',
                                    duration: 30,
                                    repeats: 'never',
                                    repeats_every_n_weeks: 1,
                                    repeats_weekly_each_days_of_the_week_mask: 0b1000000,
      ...
      it 'should return nil if the series has expired' do
        Delorean.time_travel_to(Time.zone.parse('2013-07-15 09:27:00 UTC'))
      ...
      it 'should return the second event instance when the start time is moved forward' do
        Delorean.time_travel_to(Time.zone.parse('2013-06-20 09:27:00 UTC'))
      ...
      it 'should return the second event instance with its time when the first is deleted' do
        Delorean.time_travel_to(Time.zone.parse('2013-06-15 09:27:00 UTC'))
        @event.remove_from_schedule(Time.zone.parse('2013-6-16 09:00:00 UTC'))
        expect(@event.next_event_occurrence_with_time[:time]).to eq('2013-06-23 09:00:00 UTC')
      end

      it 'should return the event instance when it is not recurring and the event occurs in the future' do
        Delorean.time_travel_to(Time.zone.parse('2013-06-05 09:27:00 UTC'))
        expect(@event2.next_event_occurrence_with_time[:time]).to eq('2013-06-11 09:00:00 UTC')
      end

      it 'should not return the event instance when it is not recurring' do
        Delorean.time_travel_to(Time.zone.parse('2013-06-15 09:27:00 UTC'))
        expect(@event2.next_event_occurrence_with_time).to be_nil
      end
    end
    ...
    describe '#next_occurences' do
      ...
      it 'should return the next occurence of the event' do
        Delorean.time_travel_to(Time.zone.parse('2014-03-07 09:27:00 UTC'))
        t = @event.next_occurrence_time_method
        expect(t).to eq(Time.zone.parse('2014-03-07 10:30:00 UTC'))
      end

      # it 'includes the event that has been started within the last 15 minutes' do
      #   Delorean.time_travel_to(Time.zone.parse('2014-03-07 10:44:00 UTC'))
      #   expect(@event.next_occurrence_time_method(15.minutes.ago)).to eq(Time.zone.parse('2014-03-07 10:30:00 UTC'))
      # end

      # it 'does not include the event that has been started within more than 15 minutes ago' do
      #   Delorean.time_travel_to(Time.zone.parse('2014-03-07 10:46:00 UTC'))
      #   expect(@event.next_occurrence_time_method).to eq(Time.zone.parse('2014-03-08 10:30:00 UTC'))
      # end

      # context 'test against start_datetime and repeat_ends_on' do
      #   it 'starts in the future' do
      #     Delorean.time_travel_to(Time.zone.parse('2014-03-01 09:27:00 UTC'))
      #     expect(@event.next_occurrence_time_method).to eq(Time.zone.parse('2014-03-07 10:30:00 UTC'))
      #   end

      #   it 'already ended in the past' do
      #     Delorean.time_travel_to(Time.zone.parse('2016-02-07 09:27:00 UTC'))
      ...
      #       options = {limit: 2}
      #       Delorean.time_travel_to(Time.zone.parse('2014-03-08 09:27:00 UTC'))
      ...
      #       start_time = Time.zone.parse('2014-03-09 9:27:00 UTC')
      #       Delorean.time_travel_to(Time.zone.parse('2014-03-05 09:27:00 UTC'))
      #       expect(@event.next_occurrence_time_method(start_time)).to eq(Time.zone.parse('2014-03-09 10:30:00 UTC'))
      #     end
      #   end
      #end
    end
    ...
    describe 'Event#start_datetime_for_collection for starting event' do
      ...
      it 'should return the start_time if it is specified' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-23 09:27:00 UTC'))
    ...
    describe 'Event#final_datetime_for_collection for repeating event with ends_on' do
      ...
      it 'should return the options[:endtime] if that comes before repeat_ends_on' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-15 09:27:00 UTC'))
      ...
      it 'should return the repeat_ends_on datetime if there is no options[end_time] and ' \
         'the ends_on datetime is less than 10 days away' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-23 09:27:00 UTC'))
  ...
  #   it 'should return events that were schedule 30 minutes earlier or less
  #     if we change collection_time_past to 30.minutes' do
  ...
  # end
    ...
    describe '#upcoming_events' do
      ...
      it 'shows future events' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-15 09:25:00 UTC'))
        expect(Event.upcoming_events.count).to eq(2)
      end

      it 'does not show finished events' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-15 09:51:00 UTC'))
        expect(Event.upcoming_events.count).to eq(1)
      end

      it 'returns event 1 minute before ending' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-15 09:54:00 UTC'))
        expect(Event.upcoming_events.count).to eq(1)
      end

      it 'does not return event 1 minute after ending' do
        Delorean.time_travel_to(Time.zone.parse('2015-06-15 09:56:00 UTC'))
    ...
    describe '.future events' do
      it 'does not pull non-repeating past events' do
        ...
        Delorean.time_travel_to(Time.zone.parse('2018-06-15 10:30:00 UTC'))
      ...
      context 'pulling past events that repeat' do
        ...
        it 'should not return event with an end date in the past' do
          ...
          Delorean.time_travel_to(Time.zone.parse('2018-11-15 10:30:00 UTC'))
          expect(Event.future_events.count).to eq(0)
        end
        ...
        it 'should return event with an end date in the future' do
          ...
          Delorean.time_travel_to(Time.zone.parse('2018-10-28 10:30:00 UTC'))
          expect(Event.future_events.count).to eq(1)
        end
